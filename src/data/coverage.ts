...
export const coverageTaxonomies: CoverageTaxonomy[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Cancers', status: 'gap', matchedSlugs: [], note: 'The second-largest cause of death worldwide: 9.7 million deaths in 2022 (GLOBOCAN), lung alone 1.8 million. Zero presence on the index. The largest gap on this page by deaths.' },
