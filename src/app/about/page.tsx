      ...
      <main>
        <section className="pt-28 pb-20 px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-emerald-400 font-medium tracking-[0.2em] uppercase text-xs mb-3">
              The thesis
            </p>
            <h1 className="font-display text-4xl md:text-6xl font-bold leading-[1.1] mb-8">
            ...
            <div className="space-y-10 text-slate-300 leading-relaxed text-lg">
              ...
              <div className="border-l-2 border-indigo-500/40 pl-6 italic text-slate-400">
                ...
                <span className="block not-italic text-sm mt-2 text-slate-500">
                  Trae Stephens & Markie Wagner, Choose Good Quests (2023)
                </span>
              </div>

              <h2 className="font-display text-2xl font-bold text-slate-100 pt-4">
                What this is
              </h2>
              <p>
              ...
              <p>
                Targeted at two audiences: <span className="text-slate-100">capital
                allocators</span> deciding where dollars should move, and{' '}
                <span className="text-slate-100">entrepreneurs</span> deciding what to
              ...
              <ul className="space-y-3 text-slate-400 text-base">
                <li>
                  <span className="text-slate-200">Not a startup idea browser.</span> This
                ...
                <li>
                  <span className="text-slate-200">Not a charity evaluator.</span>{' '}
                  GiveWell exists and is excellent. This is upstream of where they work.
                </li>
                <li>
                  <span className="text-slate-200">Not a job board.</span> Yet. The
                  &ldquo;common app for good quests&rdquo; is v1, not v0.
                </li>
                <li>
                  <span className="text-slate-200">Not for sale.</span> No company pays to
              ...
              <ul className="space-y-3 text-slate-400 text-base">
                <li>
                  <span className="text-slate-200">David Deutsch &amp; Karl Popper</span>:
                  critical rationalism, the soluble-problem thesis
                </li>
                <li>
                  <span className="text-slate-200">Trae Stephens &amp; Markie Wagner</span>:
                  the Choose Good Quests framing
                </li>
                <li>
                  <span className="text-slate-200">80,000 Hours</span>: the ITN framework for
                  importance, tractability, neglectedness
                </li>
                <li>
                  <span className="text-slate-200">Copenhagen Consensus Center</span>:
                  benefit-cost analysis for welfare interventions
                </li>
                <li>
                  <span className="text-slate-200">Jason Crawford &amp; Roots of Progress</span>:
                  the progress-studies canon
                </li>
                <li>
                  <span className="text-slate-200">Patrick Collison &amp; Tyler Cowen</span>:
                  the case for scientific productivity as meta-cause
                </li>
                <li>
                  <span className="text-slate-200">Conjecture Institute</span>: applying
                  critical rationalism to AI safety specifically
                </li>
                <li>
                  <span className="text-slate-200">The Rise Fund</span>: Impact Multiple of
                  Money methodology
                </li>
              </ul>
